...
"""
黄金价格监控脚本
- 从新浪财经获取上海金交所 Au99.99 实时报价（人民币/克，作为积存金平替）
- 记录每天北京时间9点开盘价
- 与上次记录对比，判断是否需要通知
...
def fetch_sina_gold_price() -> dict:
    """从新浪财经获取上海金交所 Au99.99 报价（作为积存金平替）"""
...
def main():
    try:
        # 1. 获取新浪财经 Au99.99 报价
        price_data = fetch_sina_gold_price()
